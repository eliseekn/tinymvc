...
<div class="alert alert-success alert-dismissible show" role="alert">
    ...
    <?php foreach (get_flash_messages('flash_messages') as $flash_message) : echo $flash_message . '<br>'; endforeach; ?>
...
<div class="card">
    ...
    <form method="post" action="<?= absolute_url('/admin/users/update/' . $user->id) ?>">
        ...
        <div class="card-footer">
            <input type="submit" class="btn btn-primary mr-2" value="Update user">
